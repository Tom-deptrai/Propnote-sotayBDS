...
class ListFilters {
  ...
  bool get isActive =>
      statuses.isNotEmpty || price.start > 0 || price.end < 50 || area.start > 0 || area.end < 250;
            ...
            Wrap(
              ...
              children: PropertyStatus.values.map((s) {
                ...
                return FilterChip(
                  ...
                  side: BorderSide(color: selected ? s.color : AppColors.border),
                  onSelected: (v) {
                    setState(() => v ? _statuses.add(s) : _statuses.remove(s));
                  },
                );
              }).toList(),
            ),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: () {
                  Navigator.pop(
                    context,
                    ListFilters(statuses: _statuses, price: _price, area: _area),
                  );
                },
